...
<head>
    ...
    <body>
        ...
        <div class="div_head">
            <span>
                ...
                <span style="float: right; margin-right: 8px; font-weight: bold;">
                    <a style="text-decoration: none;" href="javascript:history.back(-1)">【申请】</a>
                </span>
            </span>
        </div>
        <div></div>
        <div class="div_search">
            <span>
                <form action="../exam/selectAll2.do" method="get">
                   考试编号: 
            ...
            <table class="table_a" border="1" width="100%">
				...
				<c:forEach items="${examBeans}" var="item">
					 <tr id="product1">
						...
						<td>
								<a href="../exam/select2.do?examId=${item.examId}">明细</a>
								<a href="../exam/updateOK.do?examId=${item.examId}">审核通过</a>						
								<a href="../exam/updateOFF.do?examId=${item.examId}">驳回</a>													
						</td>
                    </tr>
				</c:forEach>	
                    <tr>
	...
	<c:if test="${page.pageNum > 1 }">
    <a href="../exam/selectAll2.do?pageNum=1&examId=${examId}&starttime=${starttime }&endtime=${endtime }">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="../exam/selectAll2.do?pageNum=${page.pageNum - 1 }&examId=${examId}&starttime=${starttime }&endtime=${endtime }">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
	</c:if>
	 ...
	 <c:if test="${page.pageNum != page.totlePages }"> 
	<a href="../exam/selectAll2.do?pageNum=${page.pageNum + 1 }&examId=${examId}&starttime=${starttime}&endtime=${endtime}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="../exam/selectAll2.do?pageNum=${page.totlePages }&examId=${examId}&starttime=${starttime }&endtime=${endtime }">尾页</a>&nbsp;&nbsp;&nbsp;&nbsp;
	 </c:if>
	 当前页 ${page.pageNum }&nbsp;&nbsp;&nbsp;&nbsp;
	分页单位${page.pageRows }&nbsp;&nbsp;&nbsp;&nbsp;
	总页数${page.totlePages }&nbsp;&nbsp;&nbsp;&nbsp; 
